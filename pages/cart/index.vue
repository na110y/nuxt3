  ...
  <div class="container">
    <div class="cart-content">
      ...
      <table>
        ...
        <tr class="item-cart" v-for="item in listCart" :key="item._value.id">
          ...
          <td class="cart-delele" @click="deleteCart(item._value.id)">Xóa</td>
      ...
      <div class="submit">
        ...
        <div class="btn-order">Mua <hàng></hàng></div>
      </div>
    </div>
